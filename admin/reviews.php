    ...
    <div class="wrapper">
        ...
        <div id="content">
                            ...
                            <tbody>
                                <?php while ($row = $stmt->fetch()) { ?>
                                    <tr>
                                        ...
                                        <td><?= $row['text'] ?></td>
                                        <td><?= $row['stars'] ?></td>
                                        <td class="text-center"><a href="/admin/forms/ds.php?id=<?= $row['id'] ?>" class="btn-sm btn-primary">Delete</a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
            ...
            <div class="card border-0 mt-5">
                ...
                <div class="card-body">
                    <form action="/admin/forms/as.php" method="POST">
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group">
                                    <label for="logo">Name</label>
                                    <input type="text" class="form-control" id="logo" name="name" placeholder="polite#1745" required>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label for="img">Text</label>
                                    <input type="text" class="form-control" id="img" name="text" placeholder="Truly a 5 star service" required>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label for="stars">Stars</label>
                                    <select class="form-select form-select-lg form-control" id="stars" name="stars" aria-label="Default select example">
